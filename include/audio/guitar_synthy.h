...
public:
    ...
    const float Cmajor[6] = {82.41, 130.81, 164.81, 196.00, 261.63, 329.63};  // C - E - G
    ...
    const void playString1() {
        string1.noteOn(Cmajor[0], 1);
    }

    const void playString2() {
        string2.noteOn(Cmajor[1], 1);
    }

    const void playString3() {
        string3.noteOn(Cmajor[2], 1);
    }

    const void playString4() {
        string4.noteOn(Cmajor[3], 1);
    }

    const void playString5() {
        string5.noteOn(Cmajor[4], 1);
    }

    const void playString6() {
        string6.noteOn(Cmajor[5], 1);
    }
