...
namespace audio {
    ...
    //CLUSTER 1
    constexpr char kChimeStrike1[13] = "808CLAP.WAV";
    ...
    constexpr char kChimeSway1[13] = "MOONJAZZ.WAV";
    ...
    const char clusterStrike1[13][6] {*kChimeStrike1, *kChimeStrike2, *kChimeStrike3, *kChimeStrike4, *kChimeStrike5, *kChimeStrike6 };
    const char clusterSway1[13][6] {*kChimeSway1, *kChimeSway2, *kChimeSway3, *kChimeSway4, *kChimeSway5, *kChimeSway6};
