...
class H2HAudio : public AudioSender
{
    ...
    // char* aWinGame =    "PONGWINA";
    char* aWinGame =    "TOBECON";//"PONGWINA";                      //"TOBECON";

    char* bHit =        "TRGTHIT5";
    char* bMiss =       "TRGTHIT4";
    // char* bWinLane =    "<11THRUST2.WAV>";
    char* bWinLane =    "<21CHEWY.WAV>";//"<21THRUST2.WAV>";                  //"<21CHEWY.WAV>";
    // char* bWinGame =    "PONGWINA";
